...
//		sprLeg.animate(new long[] {200,200,200} ,new int[] {0,1,2},0);
			...
			bdLeg.applyLinearImpulse(new Vector2(napX*jumpForceX,-jumpForceY), bdLeg.getWorldCenter());//.setTransform(x,bodyBody.getPosition().y , );
	...
	//------------------------------------------------------------------------------------------
	public Zombie(float x,float y,final GameScene mScene2, PhysicsWorld mPhysicsWorld, main game) {
		this.mRes =game.mRes;
	...
	//	 bdLeg.setFixedRotation(true);
       ...
       float time = (float) (Math.random()*3+2);
